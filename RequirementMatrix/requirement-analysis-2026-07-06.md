# Requirement analysis - 2026-07-06
...
Initial score for the day is not certified as 60/60 until `demo/scripts/verify-rubric-readiness.ps1` executes successfully from the repository root with the 2026-07-06 evidence files present.
