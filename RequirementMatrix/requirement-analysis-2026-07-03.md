# Requirement analysis - 2026-07-03
...
Initial score for the day is not certified as 60/60 until `demo/scripts/verify-rubric-readiness.ps1` executes successfully from the repository root with the 2026-07-03 evidence files present.
