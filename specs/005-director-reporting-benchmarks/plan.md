...
> **Forward note (2026-06-26)**: The reporting **backend** described here is **superseded by Feature 018 (Director Fabric “Rayfin” App)**, which replaces Power BI Embedded with a native EU-resident Fabric app. **This feature is already implemented and is unchanged** — it remains the source of the approved metric/benchmark/suppression definitions and the parity baseline, and its Power BI path stays available as the fallback during 018's migration. No rework of Feature 005 is implied.
