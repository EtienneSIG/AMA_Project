# LearnEU - narratif oral ANCRE pour CXO

Version : coaching en français, phrases à dire en anglais.  
Source deck : `LearnEU-Executive-Restitution-Visual.pptx`  
Usage : préparation orale uniquement. Les slides et les notes PowerPoint ne sont pas modifiées.
...
| Lettre | Intention | Application |
| --- | --- | --- |
| A - Ask décisionnel | Ouvrir par la décision attendue | Mandat, financement, owners, KPI. |
| N - Nouer le contraste | Status quo vs futur possible | Même contenu / enfants différents / futur personnalisé et gouverné. |
| C - Convertir en preuve | 1 slide = 1 message + 1 preuve | Chaque slide prouve un morceau du modèle opératoire. |
| R - Réduire la charge cognitive | Mots-clés, pauses, blocs courts | Une phrase, une preuve, une transition. |
| E - Enchaîner démo & Q&A | Démo = preuve, Q&A = renforcement | Revenir toujours à contrôle, preuve, gouvernance. |

## Ask d'ouverture à dire en anglais
...
1. **Fonction narrative** : ouverture / responsabilité.
2. **Phrase à dire** : "When AI enters children's education, responsibility must come before performance."
3. **Preuve** : citation Peter Parker, ton responsabilité.
4. **Mot-clé** : Responsibility.
5. **Transition** : "So I will present LearnEU as an operating model for responsible AI in education."
6. **Respiration** : pause 2 secondes après la citation.
7. **Question CXO probable** : Pourquoi commencer ainsi ?
8. **Réponse AES** : "Because the business case depends on trust. The evidence is that this deck measures controls as much as usage. Stop."
9. **Dire / ne pas dire / Q&A** : Dire le ton. Ne pas expliquer Spider-Man. Garder la gouvernance pour slides 10-13.
...
1. **Fonction narrative** : enjeu d'échelle.
2. **Phrase à dire** : "This is not about an app. It is about a promise to 4.1 million children."
3. **Preuve** : 4.1M learners, personalized, private, European.
4. **Mot-clé** : Scale.
...
1. **Fonction narrative** : contrat exécutif.
2. **Phrase à dire** : "This is the executive contract: impact, productivity, compliance, and accountability."
3. **Preuve** : 4.1M learners, -26pp gap, -45% admin, 100% GDPR/AI Act target.
4. **Mot-clé** : Contract.
5. **Transition** : "Now, why is this contract needed? Because the problem is not content."
6. **Respiration** : pause après executive contract.
7. **Question CXO probable** : Quel chiffre compte le plus ?
8. **Réponse AES** : "Teacher time and localization prove early value; outcome-gap reduction proves strategic value. Stop."
9. **Dire / ne pas dire / Q&A** : Dire objectifs pilotes. Ne pas promettre zéro risque.

## Slide 5 - Same content. Different kids. 40-point gap.

1. **Fonction narrative** : contraste.
2. **Phrase à dire** : "The status quo gives the same content to different children, and the gap remains."
3. **Preuve** : 40-point gap, delivery problem.
4. **Mot-clé** : Gap.
5. **Transition** : "If the issue is delivery, the answer must personalize without breaking trust."
6. **Respiration** : pause après 40-point gap.
7. **Question CXO probable** : Pourquoi pas juste un problème de programme ?
8. **Réponse AES** : "Because the same content creates different trajectories. We need to measure mastery, feedback, teacher time, and cohort fairness. Stop."
9. **Dire / ne pas dire / Q&A** : Dire le contraste. Garder pédagogie détaillée pour Q&A.
...
7. **Question CXO probable** : La conformité ralentit-elle ?
8. **Réponse AES** : "If done late, yes. If designed in, it gives permission to scale. The next slides show the gates. Stop."
9. **Dire / ne pas dire / Q&A** : Dire condition d'adoption. Ne pas dire risque zéro.
...
7. **Question CXO probable** : Où est la valeur business ?
8. **Réponse AES** : "Teacher productivity, localization speed, learner retention, and avoided late remediation. Stop."
9. **Dire / ne pas dire / Q&A** : Dire board-level scorecard. Ne pas lire tous les chiffres.

## Slide 8 - Lucas, Klaus, Sophie

1. **Fonction narrative** : preuve humaine.
2. **Phrase à dire** : "Value becomes real when each persona wins without sacrificing trust."
3. **Preuve** : Lucas niveau adapté, Klaus override, Sophie consentement.
4. **Mot-clé** : Human.
5. **Transition** : "Three different experiences, one governed backend."
6. **Respiration** : une respiration par persona.
7. **Question CXO probable** : Pourquoi les enseignants accepteraient ?
8. **Réponse AES** : "Because they keep authority and get time back. AI assists; the teacher decides. Stop."
9. **Dire / ne pas dire / Q&A** : Une phrase par persona. Ne pas lire la liste.

## Slide 9 - One platform. Three AIs. Zero data leaving the EU.

1. **Fonction narrative** : solution.
2. **Phrase à dire** : "The differentiator is not the AI model. It is the controlled environment around several AI uses."
3. **Preuve** : ONNX, Azure OpenAI/RAG, structured grading, EU regions.
4. **Mot-clé** : Platform.
5. **Transition** : "That platform must now prove compliance as a gate, not a promise."
6. **Respiration** : pause après zero data leaving the EU.
7. **Question CXO probable** : Une plateforme ou plusieurs apps ?
8. **Réponse AES** : "Several surfaces, one governed backend. Identity, data, and audit controls remain common. Stop."
9. **Dire / ne pas dire / Q&A** : Dire le principe. Garder les services pour Q&A.
...
7. **Question CXO probable** : Comment gérez-vous l'AI Act ?
8. **Réponse AES** : "With mapped artifacts: risk, documentation, logs, transparency, oversight, and monitoring. If evidence is missing, the gate blocks. Stop."
9. **Dire / ne pas dire / Q&A** : Dire evidence before release. Garder Annex IV pour Q&A.
...
7. **Question CXO probable** : Cela réduit-il l'efficacité ?
8. **Réponse AES** : "No. AI automates preparation, explanation, and measurement; humans keep sensitive decisions. Stop."
9. **Dire / ne pas dire / Q&A** : Dire ligne rouge. Ne pas promettre autonomie totale.

## Slide 12 - Less data. Better governed.

1. **Fonction narrative** : preuve data.
2. **Phrase à dire** : "The data model reduces risk by minimizing, encrypting, and making audit possible."
3. **Preuve** : 0 PII in Gold, 30-day erasure SLA, 100% CMK, 3 regions.
4. **Mot-clé** : Minimization.
5. **Transition** : "Minimization must also be enforced by network, keys, and audit."
6. **Respiration** : ne pas commenter tous les chiffres.
7. **Question CXO probable** : Logs vs droit à l'effacement ?
8. **Réponse AES** : "Personal data is removed from operational stores; logs keep evidence through hashed references. Stop."
9. **Dire / ne pas dire / Q&A** : Dire minimisation. Garder schéma data pour Q&A.
...
7. **Question CXO probable** : Peut-on stopper une feature ?
8. **Réponse AES** : "Yes. The model includes feature pause, incident routing, and a kill switch under five minutes. Stop."
9. **Dire / ne pas dire / Q&A** : Dire stoppable. Ne pas survendre infaillibilité.
...
3. **Preuve** : Steering, RAI gate, 9 agents, QA verifier.
4. **Mot-clé** : Owners.
5. **Transition** : "That governance becomes a roadmap with hard stops."
6. **Respiration** : ne pas lire toutes les cartes.
7. **Question CXO probable** : Qui décide la release ?
...
3. **Preuve** : P0-P1, NL pilot, CE marked, third market, DR drill.
4. **Mot-clé** : Gates.
5. **Transition** : "The demo now proves the path, not the entire product."
6. **Respiration** : pause après hard stop.
7. **Question CXO probable** : Prochain pas concret ?
...
7. **Question CXO probable** : Que regarder ?
...
3. **Preuve** : 5 KPIs, 6 risks, posture, cost per learner.
4. **Mot-clé** : Board.
5. **Transition** : "This monthly governance leads to today's decisions."
6. **Respiration** : pause après every month.
7. **Question CXO probable** : Comment gouverner le coût ?
...
6. **Respiration** : brève.
7. **Question CXO probable** : Pourquoi ne pas tout montrer ?
...
7. **Question CXO probable** : Que finance-t-on ?
...
7. **Question CXO probable** : Comment éviter les claims locaux ?
...
7. **Question CXO probable** : Pourquoi parler méthode ?
...
7. **Question CXO probable** : Apport réel des agents ?
...
3. **Preuve** : AI Act, GDPR, RAI, pedagogy, QA, deployment, scale.
4. **Mot-clé** : Specialists.
5. **Transition** : "The control squad needed a repeatable delivery workflow."
6. **Respiration** : pointer 3 rôles, ne pas lire.
7. **Question CXO probable** : Comment éviter divergence ?
...
7. **Question CXO probable** : Pourquoi important business ?
